...
#HELLOTCL_NEW_VAR	= @HELLOTCL_NEW_VAR@
CFLAGS_DEBUGLOG =  
...
PKG_SOURCES	=  tclsevenzip.cpp lib7zipcmd.cpp lib7ziparchivecmd.cpp lib7zipstream.cpp tclcmd.cpp
PKG_OBJECTS	=  tclsevenzip.o lib7zipcmd.o lib7ziparchivecmd.o lib7zipstream.o tclcmd.o
...
PKG_LIB_FILE	= libsevenzip0.1.so
PKG_LIB_FILE8	= libsevenzip0.1.so
PKG_LIB_FILE9	= libtcl9sevenzip0.1.so
PKG_STUB_LIB_FILE = libsevenzipstub0.1.a
...
top_builddir	= /home/oleg/src/tcllib7zip
...
TCLSH_PROG	= /opt/tcl8.6g/bin/tclsh8.6
...
INCLUDES	=  -I"/home/oleg/src/tcllib7zip/../lib7zip/src" -I"/home/oleg/src/tcllib7zip/../lib7zip/third_party/7zip" -I"/opt/tcl8.6g/include" -I.
#INCLUDES	=  -I"/home/oleg/src/tcllib7zip/../lib7zip/src" -I"/home/oleg/src/tcllib7zip/../lib7zip/third_party/7zip" -I"/opt/tcl8.6g/include" @TK_INCLUDES@ @TK_XINCLUDES@
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"sevenzip\" -DPACKAGE_TARNAME=\"sevenzip\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"sevenzip\ 0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_sevenzip=/\*\*/ -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"sevenzip\" -DPACKAGE_TARNAME=\"sevenzip\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"sevenzip\ 0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_sevenzip=/\*\*/ -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
...
CPPFLAGS	= 
LIBS		=  -Wl,--no-undefined -lstdc++ -L/home/oleg/src/tcllib7zip/../lib7zip/src -L/home/oleg/src/tcllib7zip/../lib7zip/build/src -l7zip 
AR		= ar
CFLAGS		=  -pipe ${CFLAGS_DEFAULT} ${CFLAGS_WARNING} ${SHLIB_CFLAGS} 
LDFLAGS		=  -Wl,--export-dynamic 
LDFLAGS_DEFAULT			= 
COMPILE		= $(CC) $(DEFS) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) \
			  $(CFLAGS_DEFAULT) $(CFLAGS_WARNING) $(CFLAGS_DEBUGLOG) $(SHLIB_CFLAGS) $(CFLAGS)
...
tclsevenzipUuid.h:	$(srcdir)/manifest.uuid
	echo "#define SEVENZIP_VERSION_UUID \\" >$@
